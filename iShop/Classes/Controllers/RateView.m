...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
		...
		self.notSelectedImage = [UIImage imageNamed:@"star_none.png"];
		self.halfSelectedImage = [UIImage imageNamed:@"keditbookmarks.png"];
		self.fullSelectedImage = [UIImage imageNamed:@"keditbookmarks.png"];
